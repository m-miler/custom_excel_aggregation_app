...
class Utils:
    ...
    def save_settings_to_json_file(settings: dict) -> None:
        ...
        with open(f'custom_excel_aggregation_app/survey_settings/{settings_file_name}.json', 'w', encoding='utf-8') as file:
    ...
    def check_if_setting_file_exist(survey_name: str) -> dict | None:
        ...
        settings_file_path = f"custom_excel_aggregation_app/survey_settings/settings_{survey_name}.json"
